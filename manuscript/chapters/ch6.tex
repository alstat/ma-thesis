...
\begin{figure}[!h]
    \centering
    \includegraphics[width=1.35\textwidth]{img/plot1-landscape.pdf}
    \caption{Count Statistics of Meccan and Medinan \arb[trans]{sUwar} \arb{suwar}}
...
\begin{landscape}
    \begin{figure}[!h]
        \centering
        \includegraphics[width=1.35\textwidth]{img/plot2-landscape.pdf}
...
\begin{table}[!t]
    ...
    \begin{tabularx}{\textwidth}[!t]{ccc}
        ...
        UTM2292\parnote{\url{https://corpuscoranicum.de/en/manuscripts/2292/page/173v?sura=43&verse=58}} & 750 - 900 CE & \includegraphics[width=0.6\textwidth]{img/old_quran_manuscripts/43-58 (750-900) Universitätsbibliothek Tübingen Ma VI 150.png}\\
        ...
        }} & 800 - 1000 CE & \includegraphics[width=0.6\textwidth]{img/old_quran_manuscripts/43-58 (800-1000) Bibliothèque nationale de France, Arabe 334 (j).png}\\
        BFA783\parnote{\url{https://corpuscoranicum.de/en/manuscripts/783/page/219v?sura=43&verse=58}} & 900 - 1000 CE & \includegraphics[width=0.6\textwidth]{img/old_quran_manuscripts/43-58 (900-1000) Bibliothèque nationale de France, Arabe 6430.png}\\
        \bottomrule
    \end{tabularx}
    \begin{flushleft}
        \vspace{-0.3cm}
...
\begin{table}[!t]
    ...
    \begin{tabularx}{\textwidth}[!t]{ccc}
        ...
        UTM2292\parnote{\url{https://corpuscoranicum.de/en/manuscripts/2292/page/71r?sura=21&verse=59}} & 750 - 900 CE & \includegraphics[width=0.6\textwidth]{img/old_quran_manuscripts/21-59 (750 - 900) Universitätsbibliothek Tübingen, Ma VI 150.png}\\
        ...
        BFA783\parnote{\url{https://corpuscoranicum.de/en/manuscripts/783/page/154r?sura=21&verse=59}} & 900 - 1000 CE & \includegraphics[width=0.6\textwidth]{img/old_quran_manuscripts/21-59 (900-1000) Bibliothèque nationale de France, Arabe 6430.png}\\
...
\begin{table}[!t]
    ...
    \begin{tabularx}{\textwidth}[!t]{cc>{\centering\arraybackslash}p{0.6\textwidth}}
        ...
        \midrule
        Cairo & 1924 CE &
            \arb[fullvoc]{wa-'in kuntum fI raybiN mimmA nazzalnA `alY_a `abdinA fa'tUA bisUraTiN mmin mmi_tlihi wa-"ad`UA ^suhada'A'akum mmin dUni \arbcolor[red]{'l-lahi} 'in kuntum .sa--_a--diqIna}
        \\[0.2cm]
        TPM53\parnote{\url{https://corpuscoranicum.de/en/manuscripts/53/page/3v?sura=2&verse=23}} & 700 - 800 CE & \includegraphics[width=0.57\textwidth]{img/old_quran_manuscripts/2-23 (700-800) Topkapı Palace Museum (Topkapı Sarayı Müzesi), Saray 50385 (Gotthelf Bergsträßer archives).png}\\
        ...
        BFA46\parnote{\url{https://corpuscoranicum.de/en/manuscripts/46/page/1r?sura=2&verse=23}} & 750 - 1000 CE & \includegraphics[width=0.57\textwidth]{img/old_quran_manuscripts/2-23 (750-1000) Bibliothèque nationale de France Arabe 350 (a).png}\\
...
\begin{bottomtitledframe}{Qur'\=an 55:13}
    \begin{center}
        \begin{arab}
            min ((sUraTu 'l-ra.hm_ani)): \txarb{فَبِأَىِّ} |"'-AlA'i rabbikumA tuka_d_dibAni
        \end{arab}
        \begin{arab}[trans]
...
If there is one interesting pattern that needs focus on, it is the 15 syllables \arb[trans]{'AyAt} \arb{'AyAt} \newline shown in Figure \ref{fig:result_rhythmic_pattern_10_25}. This is because there is an obvious rhythmic pattern that seem to be repeated, the pattern has prolongation with \arb[trans]{maddaT} \arb{maddaT} in its sixth syllable which is preceded by a long vowel in its fifth syllable. Upon close inspection these are all refrain verses from \arb[trans]{sUraTu 'l-ra.hm_ani} \arb{sUraTu 'l-ra.hm_ani}, the first of its refrain is in verse 13 shown in Qur'\=an 55:13 block above. In total this refrain is repeated 31 times, but in Figure \ref{fig:result_rhythmic_pattern_10_25}, there are two other \arb[trans]{'ayaT} \arb{'ayaT} as well from the same \arb[trans]{sUraT} \arb{sUraT}, \arb[trans]{sUraTu 'l-ra.hm_ani} \arb{sUraTu 'l-ra.hm_ani} with 15 syllables, and these are \arb[trans]{'AyAt} \arb{'AyAt} 27 and 78, both are shown in Qur'\=an 55:27 and 55:78 below, respectively.
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=\textwidth]{img/rhythmic_trans_clusters.pdf}
...
and \arb[trans]{sUraTu 'l-mA`Un} \arb{sUraTu 'l-ma`Un}, which is the same findings from Section \ref{sec:last_recited_syllable_pattern}, specifically in Figure \ref{fig:result_last_syllable_rhythmic_cross_similarities}. Further, for Cluster 2, the following are the \arb[trans]{suwar} \arb{suwar} that were found to have similar rhythmic transition probabilities: Q99, Q100, Q102, Q103, Q105, Q112, Q113, and Q114. Looking at this cluster, the \arb[trans]{suwar} \arb{suwar} are a group of short \arb[trans]{suwar} \arb{suwar}, which talks topics like warning about judgment and materialistic distractions (Q99 and Q102); salvation through faith, good deeds, truth, and patience (Q103); definition of pure monotheism (Q112); and prayer \arb[trans]{suwar} \arb{suwar}, Q113 and Q114, for protection from external and internal evils respectively. Finally, the rest of the \arb[trans]{suwar} \arb{suwar} are distributed to either Cluster 1 or 4. Cluster 1 in particular contains \arb[trans]{suwar} \arb{suwar} which has high transition probabilities from \arb[trans]{maddaT} \arb{maddaT} to short vowels, and low probability on \arb[trans]{maddaT} \arb{maddaT} to long vowels. Lastly, Cluster 4 contains \arb[trans]{suwar} \arb{suwar} whose transition probabilities grouped into three: the first three (\textit{Short vowel} $\rightarrow$ \textit{Short vowel}, \textit{Long vowel} $\rightarrow$ \textit{Short vowel}, \textit{Maddah} $\rightarrow$ \textit{Short vowel})of the transition states have probabilities close to 1.0, the next three transition states have probabilities around 0.5, and the last three transition states (\textit{Short vowel} $\rightarrow$ \textit{Maddah}, \textit{Long vowel} $\rightarrow$ \textit{Maddah}, \textit{Maddah} $\rightarrow$ \textit{Maddah}) have probabilities close to 0.0.
...
As pointed out by Sayyed Hossein Nasr in \citeA{nasr2013history}, Islamic philosophy is essentially a ``prophetic philosophy'' rooted in the hermeneutics of a Sacred Text---a revelation intrinsically linked to the microcosmic intellect, which alone can actualize the dormant capacities of the human mind. He further asserts that Islamic philosophy, as understood within its own tradition, is an unveiling of the inner meaning of the Sacred Text and a means of access to the \arb[trans]{.haqIqaT} \arb{.haqIqaT}\footnote{From \cite{nasr2013history}, \arb[trans]{'l-.haqIqaT} \arb{'l-.haqIqaT} means both truth and reality. It is related to God Himself, one of whose names is \arb[trans]{'l-.haqq} \arb{'l-.haqq}, or ``the Truth,'' and represents the ultimate reality whose discovery is the goal of all Islamic philosophy.} hidden within the inner dimension of the Qur'\=an. Indeed, the effort of applying complex analytics is hoped to help in accessing the said \arb[trans]{'l-.haqq} \arb{'l-.haqq}.

Moreover, the unique structure of the Qur'\=an—neither chronological nor following the typical arrangement of a book—is what distinguishes it from other holy scriptures. If God were to author a book, how would it be arranged or structured? This is a question I have often pondered. Had it been chronological, it might not have appeared special. In fact, any typical book structure would arguably detract from the Qur'\=an’s divine uniqueness. The distinctive arrangement and structure of the Qur'\=an have intrigued both Muslim and non-Muslim scholars. It is in the study of this structure that some aspects of the \arb[trans]{.haqIqaT} \arb{.haqIqaT} may lie. Yet, will we ever uncover this hidden structure or formula? This question will be discussed in the next section.

\subsection{The Hidden Structure of the Qur'\=an}

As shown in the preceding section of this paper, the Qur'\=an possesses an undeniably unique literary style. The strong rhythmic quality of its \arb[trans]{'AyAt} \arb{'AyAt} serves multiple purposes. Foremost among them is preservation. One must understand that the Qur'\=an, as believed by Muslims, was revealed orally, transmitted orally, and preserved orally. At the time of its revelation, Arabic orthography was in its rudimentary form: letters had no diacritical marks, no vowels—only the \arb[trans]{rasm} \arb{rasm}, or consonantal skeleton.

The development of Arabic orthography was driven by the need to capture the intricate recitation of the Qur'\=an. Long vowels and the \arb[trans]{maddaT} \arb{maddaT} were introduced to accurately represent the oral tradition of this sacred text. However, the rationale behind its arrangement remains elusive. Can we ever truly discover it?

If the Qur'\=an is the Word of God, then uncovering its hidden structure or formula would, in essence, reveal something of God's thinking. Such a truth—or to be precise, \arb[trans]{.haqIqaT} \arb{.haqIqaT}—would carry immense implications. It would almost amount to perceiving the unseen realm, thus implying that judgment is imminent, for the time of moral choice would end with the manifestation of undeniable truth. Should this be avoided by Islamic philosophers or researchers? I would argue not, for such an approach may hinder the discovery of the Qur'\=an's hidden features, which are themselves critical to a believer's faith. Rather, we should understand that, while it may be impossible to fully comprehend the true hidden design of the Qur'\=an, we should not cease striving to uncover its underlying structure.

\subsection{Implications of Errors in Statistical Models}
