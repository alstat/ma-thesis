...
\subsection{Genetic Algorithm for Optimal Class Border}
...
\begin{enumerate}
    ...
    \item \textit{Crossover}: Combining parts of parent solutions to create new offspring solutions. In the context of structural borders, this can be 
    \item \textit{Mutation}: Random changes to maintain genetic diversity and prevent premature convergence.
\end{enumerate}
