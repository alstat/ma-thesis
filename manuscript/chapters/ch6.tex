...
\section{Genetic Algorithm for Finding Optimal Class Borders}\label{sec:ga}
...
Once the parent has been selected, the crossover and mutation as discussed in Section \ref{sec:ga}. This also include the refinement after mutation mentioned in the said section.
