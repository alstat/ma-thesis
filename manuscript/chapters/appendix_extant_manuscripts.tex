...
\begin{table}[!h]
    ...
    \begin{tabularx}{\textwidth}[!t]{cc>{\centering\arraybackslash}p{0.65\textwidth}}
        ...
        \midrule
        Cairo & 1924 CE &
            \txarb{تَنَزَّلُ ٱلْمَلَـٰٓئِكَةُ وَٱلرُّوحُ فِيهَا بِإِذْنِ رَبِّهِم مِّن كُلِّ أَمْرٍۢ}
        \\[0.2cm]
...
\begin{table}[!h]
    ...
    \begin{tabularx}{\textwidth}[!t]{cc>{\centering\arraybackslash}p{0.65\textwidth}}
        ...
        \midrule
        Cairo & 1924 CE &
            \txarb{إِلَّا ٱلَّذِينَ ءَامَنُوا۟ وَعَمِلُوا۟ ٱلصَّـٰلِحَـٰتِ وَتَوَاصَوْا۟ بِٱلْحَقِّ وَتَوَاصَوْا۟ بِٱلصَّبْرِ}
        \\[0.2cm]
